...
bus=true}
N 3960 -60 4020 -60 { lab=io_analog[2]}
N 3710 -100 3750 -100 { lab=io_analog[8]}
N 3710 -20 3750 -20 { lab=io_analog[7]}
N 2680 -90 2680 250 { lab=io_analog[10:0]
bus=true}
N 3860 -120 3860 -117.5 { lab=io_analog[3]}
N 3860 -120 3862.5 -120 { lab=io_analog[3]}
N 3860 -117.5 3900 -117.5 { lab=io_analog[3]}
...
C {lab_wire.sym} 2670 -70 0 0 {name=l20 sig_type=std_logic lab=io_analog[1:0]}
C {noconn.sym} 2670 -70 0 0 {name=l15}
C {lab_pin.sym} 2670 10 0 0 {name=l18 sig_type=std_logic lab=io_analog[2]}
C {lab_pin.sym} 2670 -30 0 0 {name=l19 sig_type=std_logic lab=io_analog[6:4]}
C {/research/mlab/chipathon/Final_schematic/biasAmp_simpClean.sym} 3830 -60 0 0 {name=X1}
C {lab_pin.sym} 3830 -130 3 1 {name=l16 sig_type=std_logic lab=vccd2}
C {lab_pin.sym} 3830 10 0 1 {name=l17 sig_type=std_logic lab=vssa2}
C {lab_pin.sym} 4020 -60 0 1 {name=l21 sig_type=std_logic lab=io_analog[2]}
C {lab_pin.sym} 3900 -117.5 0 1 {name=l22 sig_type=std_logic lab=io_analog[3]}
C {lab_pin.sym} 3710 -100 0 0 {name=l23 sig_type=std_logic lab=io_analog[8]}
C {lab_pin.sym} 3710 -20 0 0 {name=l24 sig_type=std_logic lab=io_analog[7]}
C {bus_connect_nolab.sym} 2680 50 3 1 {name=r4}
C {lab_pin.sym} 2670 60 0 0 {name=l25 sig_type=std_logic lab=io_analog[3]}
C {bus_connect_nolab.sym} 2680 100 3 1 {name=r5}
C {lab_pin.sym} 2670 110 0 0 {name=l26 sig_type=std_logic lab=io_analog[7]}
C {bus_connect_nolab.sym} 2680 150 3 1 {name=r6}
C {lab_pin.sym} 2670 160 0 0 {name=l27 sig_type=std_logic lab=io_analog[8]}
C {bus_connect_nolab.sym} 2680 200 3 1 {name=r7}
C {lab_pin.sym} 2670 210 0 0 {name=l28 sig_type=std_logic lab=io_analog[9]}
C {bus_connect_nolab.sym} 2680 250 3 1 {name=r8}
C {lab_pin.sym} 2670 260 0 0 {name=l29 sig_type=std_logic lab=io_analog[10]}
C {noconn.sym} 2670 -30 0 0 {name=l30}
